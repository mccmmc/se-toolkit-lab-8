"""Stdio MCP server for VictoriaLogs and VictoriaTraces observability data."""
...
async def main() -> None:
    ...
    async with VictoriaLogsClient(settings.nanobot_victorialogs_url) as logs_client, \
               VictoriaTracesClient(settings.nanobot_victoriatraces_url) as traces_client:
